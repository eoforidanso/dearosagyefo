...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630">
  ...
  <!-- URL badge -->
  <rect x="860" y="490" width="200" height="42" rx="21" fill="rgba(255,255,255,0.07)" stroke="rgba(232,185,35,0.35)" stroke-width="1"/>
  <text x="960" y="517" font-family="Georgia,serif" font-size="13" fill="rgba(255,255,255,0.6)" text-anchor="middle">dearosagyefo.com</text>
</svg>`;
